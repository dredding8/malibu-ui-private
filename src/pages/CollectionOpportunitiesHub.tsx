...
// UX Improvements: Cognitive load reduction components
// ActionButtonGroup removed - replaced with native Blueprint ButtonGroup (Workshop pattern)

// Legacy imports
import { AllocationProvider, useAllocationContext } from '../contexts/AllocationContext';
import CollectionOpportunitiesEnhanced from '../components/CollectionOpportunitiesEnhanced';

import { CollectionOpportunity, Site, CapacityThresholds, CollectionDeck, MatchStatus, Pass } from '../types/collectionOpportunities';
...
import { SkipToMain, LiveRegion, Announcement, KeyboardInstructions, a11y } from '../components/CollectionOpportunitiesHubAccessible';
import { usePerformanceMonitor, useDebouncedFilter, useBatchedUpdates } from '../utils/performanceOptimizations';
...
const ReallocationWorkspace = lazy(() =>
  import('../components/ReallocationWorkspace').catch(() =>
...
// Hub component content (inside provider) - memoized for performance
const CollectionOpportunitiesHubContent: React.FC = memo(() => {
  ...
  usePerformanceMonitor('CollectionOpportunitiesHubContent');
  ...
  return (
    <>
      ...
      {/* Navigation Context - Enterprise Pattern */}
...
CollectionOpportunitiesHubContent.displayName = 'CollectionOpportunitiesHubContent';

// Main hub component with provider - memoized for performance
const CollectionOpportunitiesHub: React.FC = memo(() => {
